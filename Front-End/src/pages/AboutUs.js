        ...
        <div className={styles['aboutus-container']}>
          ...
          <div className={styles.description}>
            <p>
              ...
              araya getirme amacıyla kurulan bir pazar yeri
              projesidir. <br /> <br />Türkiye’nin bütün illerinde hizmet veren projemizde
              dilediğiniz gibi profil oluşturabilir ve özel ders
              verebilirsiniz. <br /> <br />Ders vermek isteyen insanlar, illaki öğretmen veya
              eğitmen olmak zorunda değildir. Özel ders verebileceğine inanan
              öğrenci ve diğer branşlardaki insanlarda özel ders verebilirler.
              Aynı zamanda dileyen herkes özel ders alabilir. Ayrıca özel ders
              almak istediğiniz öğretmeni seçip doğrudan kendisiyle iletişime
              ...
              geldiği tartışılmaz bir gerçektir. <br /> <br /> Öğrenciler okul derslerinde
              anlamadığı konuları veya eksik olduğu derslerde kendini
              geliştirip, eğitim hayatına sağlam adımlarla devam etmek için
              alanında uzman eğitimciden özel ders almak istemektedirler. <br /><br />
